...
const CreateEmployeeModal: React.FC<CreateEmployeeModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl border border-border-light max-w-2xl w-full overflow-hidden flex flex-col max-h-[90vh]">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0">
          ...
          <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-slate-200 bg-white">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="px-4 py-2 rounded-lg bg-primary text-white font-semibold hover:bg-emerald-600 transition-colors shadow-lg shadow-primary/20 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isSubmitting ? (
                <>
